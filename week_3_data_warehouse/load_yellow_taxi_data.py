...
BUCKET_NAME = "kestra-de-zoomcamp-week3"

# If you authenticated through the GCP SDK you can comment out these two lines
CREDENTIALS_FILE = "kestra-de-453502-b892a22ca286.json"
...
def create_bucket(bucket_name):
    try:
        ...
        bucket = client.create_bucket(bucket_name, location='australia-southeast1')
